...
<div class="row content-wrapper">
 ...
 <h1 class="page-title">New VLE Registrations</h1>

          <?php
		   include("../connection.php");
		   $q=mysql_query("select * from vle where status='pending'");
    ...
    <table cellpadding="0" cellspacing="0" border="1" id="table">
      ...
      <tbody>
		   <?php
			...
			<td><a href="Approve_Reject_vle.php?id=<?php echo $a[0];?>" class="button" style="text-decoration:none; color:white">Approve-Reject</a></td>
			</tr>
			<?php
			}
		   ?>
  ...
  <strong>Info!</strong> No Pending VLE Registration.
</div>
		   <?php
		   }
		  ?> 
