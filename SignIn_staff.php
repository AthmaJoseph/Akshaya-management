...
if(isset($_POST['btn']))
{
 include("connection.php");
	 $q=mysql_query("select * from traveller_tb where username='".$_POST['txtuname']."' and password='".$_POST['txtpswd']."'");
 ...
 $_SESSION['id']=$a[0];
  $_SESSION['username']=$a['username'];
	   ?>
 <script type="text/javascript">window.location.href="Traveler/home.php";</script>
 <?php
      }
	  else
	  {
