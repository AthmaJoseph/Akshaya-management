...
<div class="row content-wrapper">
  <div class="columns large-12">
	...
	<div class="columns sidebar large-4 large-offset-1">
        ...
        <ul >
		  <li> <a href="View_cancel_booking.php"  style="font-size:18px">Tocken</a> </li>
          <li> <a href="View_packages.php"  style="font-size:18px">Feedback</a> </li>
          <li> <a href="Passenger_details.php" style="font-size:18px">Details</a> </li>
