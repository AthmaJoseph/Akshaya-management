...
<div class="row content-wrapper">
  ...
  <form id="message" id="message" method="post" action="" enctype="multipart/form-data" >
  <?php
...
<?php
		if(isset($_POST['btn']))
		{
		mysql_query("insert into customer_feedback values(0,'".$_SESSION['username']."','".$_POST['txtf']."','".date("Y-m-d")."')");
		?>
