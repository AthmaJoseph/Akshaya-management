      ...
      <div class="columns large-12 content ">
        ...
        <table width="631" height="488">
			...
			<td width="395">
			  ...
			  <tr>  <td >
			  <input type="text" name="txtempid" id="txtempid" placeholder="Emp Id(Adhar No):" required onKeyUp="checkUsername(this.value)" ><div id="txtu"></div></td></tr>
			  <tr>
			  <td>
